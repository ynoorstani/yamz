	...
	if(currentPlayer === 'computer'){
	 ...
	 function calculate(){
		...
		if (
			...
			console.log('code is being run because someone won');
			...
			// 
			console.log('run game being set to false');
			runGame = false;
		} 
		...
		if (currentPlayer === 'computer') {
			console.log('Current player is computer, changing player to human');
			currentPlayer = 'human'
			currentPlayerSymbol = 'X'
		}
		else {
			console.log('Current player is human, changing player to computer');
			currentPlayer = 'computer'
			currentPlayerSymbol = 'O'
			
		}
console.log('next turn if runGame === true.  runGame is currently: ', runGame);
		if (runGame){
...
// Set currentPlay span to be "human" or "computer" using Javascript + jQuery-->
// 	<!-- Reset game condition when computer wins and on ties-->
